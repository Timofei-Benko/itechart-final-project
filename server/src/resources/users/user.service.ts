...
const getOne = async (filter: object): Promise<IUser & { _id: string }> => User.findOne(filter);

const updateStats = async (userId: string | IUser, statsItem: string): Promise<void> => {
