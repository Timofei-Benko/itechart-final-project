...
const SET_QUESTION_DATA_LOADING = 'SET_QUESTION_DATA_LOADING';
const SET_QUESTION_DATA_SUCCESS = 'SET_QUESTION_DATA_SUCCESS';
const SET_QUESTION_DATA_ERROR = 'SET_QUESTION_DATA_ERROR';
